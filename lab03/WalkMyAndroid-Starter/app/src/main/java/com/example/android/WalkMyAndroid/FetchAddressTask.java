...
class FetchAddressTask extends AsyncTask<Location, Void, String> {
    ...
    protected String doInBackground(Location... params) {
        // Set up the geocoder, handles both geocoding (converting from an address into coordinates) and reverse geocoding
        ...
        //if no address if found, print error message
